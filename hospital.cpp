...
class Person
{
    ...
    int PhoneNum,Age,Date,Month,Year;
...
public:
    ...
    void Display_info()
    {
        ...
        cout<<"Age: "<<Age<<endl;
        cout<<"Your Birth date: "<<Date<<"-"<<Month<<"-"<<Year<<endl;
        cout<<"Address: "<<this->ZipCode<<","<<this->City<<","<<this->State<<","<<this->Country<<endl;
...
class Staff:public Person
  ...
  public:
          ...
          void staff_info()
          {
              ...
              /*cout<<"Enter staff id<for doctor(100-150),for nurse<300-400>,for receptionist(500-505)>,for store manager<10-12>):";
              cin>>staff_id;
              */
          }
...
public:
    ...
    void write_patient();	//write the record in binary file
    void display_all();	//read all records from binary file
    void display_p(int n);	//accept reg_no and read record from binary file
    void modify_patient(int n);	//accept reg_no and update record of binary file
    void delete_patient(int n);	//accept reg_no and delete selected records from binary file
    void reports();		//display result menu
 ...
 void write_receptionist()
   {
	Receptionist r;
	ofstream outFile;
	outFile.open("Receptinist.dat",ios::binary|ios::app);
	r.RecInfo();
...
void Introduction()
{
    cout<<"\n\n\t\tThe CURE HOSPITAL MANAGEMENT SYSTEM\n";
    cout<<"\n\t\tPrepared BY:\n\n";
    cout<<"\t\t01.Waliur Rahman\n";
    cout<<"\t\t02.Tanzir Ratul\n";
    cout<<"\t\t03.Enamul Haque\n";
    cout<<"\nfor client help(admin password=admin, Receptionist password=receptionist,\n";
    cout<<"Doctor password=doctor,store Manager password=store.)\n";
